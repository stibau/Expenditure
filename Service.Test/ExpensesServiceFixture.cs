...
public class ExpensesServiceFixture
{
    ...
    public void GetAllCosts_ShouldReturnTheDataAsExpected()
    {
        ...
        {
            new() { SpenderId = 1, Description = "Carrefour", Amount = 123m, Date = new DateTime(2025, 03, 15) },
            new() { SpenderId = 2, Description = "Carrefour", Amount = 50m, Date = new DateTime(2025, 04, 20) },
            new() { SpenderId = 1, Description = "Delhaize", Amount = 253m, Date = new DateTime(2025, 02, 28) },
            new() { SpenderId = 2, Description = "Delhaize", Amount = 253m, Date = new DateTime(2025, 02, 28) }
        };
